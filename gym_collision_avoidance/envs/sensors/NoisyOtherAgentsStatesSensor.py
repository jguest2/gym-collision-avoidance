...
class NoisyOtherAgentsStatesSensor(Sensor):
    ...
    def __init__(self, max_num_other_agents_observed=Config.MAX_NUM_OTHER_AGENTS_OBSERVED,
                 agent_sorting_method=Config.AGENT_SORTING_METHOD):
    ...
    def sense(self, agents, agent_index, top_down_map=None):
        ...
        for i, other_agent in enumerate(agents):
            ...
            rel_pos_to_other_global_frame[0] += np.random.normal(0, 2)  # adding x distance noise
            rel_pos_to_other_global_frame[1] += np.random.normal(0, 2)  # adding y distance noise
            other_agent_dists[other_agent.id] = rel_pos_to_other_global_frame
        ...
        for other_agent in clipped_sorted_agents:
            ...
            # rel_pos_to_other_global_frame = other_agent.pos_global_frame - \
            # host_agent.pos_global_frame
            rel_pos_to_other_global_frame = other_agent_dists[other_agent.id]
